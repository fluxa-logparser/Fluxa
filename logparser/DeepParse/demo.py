...
import openai
import argparse
from DeepParse import ModelParser
...
def main(args):
    ...
    parser = ModelParser(
                ...
                split_method = args.split_method,   # random or sensitivesampling
...
if __name__ == '__main__':
    ...
    parser.add_argument('--split_method', type=str, default='sensitivesampling', help='random or sensitivesampling')
